1. Дефинирайте тип от данни Task, който представя задача, която трябва да бъде свършена в даден проект. Задачата трябва да има име и статус. Възможните стойности на 
